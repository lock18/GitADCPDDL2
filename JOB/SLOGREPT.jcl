//#USERIDR JOB (#SALES),'ISPW',CLASS=L,MSGCLASS=X,REGION=0M,
//      MSGLEVEL=(1,1),NOTIFY=&USERID
//*
//***     THIS JOB IS FOR REPORTING STATISTICS FROM SYSLOG(S)
//STEP000 EXEC PGM=IEFBR14
//SYSPRINT DD SYSOUT=*
//DEL1 DD DSN=#USERID.SYSLOG.TXT,DISP=(MOD,DELETE),SPACE=(TRK,1)
//DEL2 DD DSN=#USERID.SYSLOGO.DATA,DISP=(MOD,DELETE),SPACE=(TRK,1)
//DEL3 DD DSN=#USERID.SYSLOGH.DATA,DISP=(MOD,DELETE),SPACE=(TRK,1)
//*
...
//HASP892  DD DSN=#USERID.SYSLOGH.DATA,DISP=(NEW,CATLG,DELETE),
//            SPACE=(TRK,(6000,1500),RLSE),UNIT=SYSDA,
//            DCB=(LRECL=133,RECFM=FB,BUFNO=50)
//SYSLOGO  DD DSN=#USERID.SYSLOGO.DATA,DISP=(NEW,CATLG,DELETE),
//            SPACE=(TRK,(6000,1500),RLSE),UNIT=SYSDA,
//            DCB=(LRECL=133,RECFM=FB,BUFNO=50)
//REPORT   DD DSN=#USERID.SYSLOG.TXT,DISP=(NEW,CATLG,DELETE),
//            SPACE=(TRK,(6000,1500),RLSE),UNIT=SYSDA,

...
000900*      WITH A LINK TO TSUBRAA
000900*      WITH A LINK TO TSUBRAB
000900*      WITH A LINK TO TSUBRAC
000900*      WITH A LINK TO TSUBRAD
001000*
001100*      AND COPYLIBS   TCPYAA    (HEADER)
001200*                     TCPYBA    (LINK AREA)
001300* ======================================================
001400*  ISPW (TM)
...
008900     CALL 'TSUBRAA' USING PASS-ME-AROUND.
008900     CALL 'TSUBRAB' USING PASS-ME-AROUND.
008900     CALL 'TSUBRAC' USING PASS-ME-AROUND.
008900     CALL 'TSUBRAD' USING PASS-ME-AROUND.
009000
...
013700     CALL 'TSUBRAA' USING PASS-ME-AROUND.
013800
...
014400        CALL 'TSUBRAA' USING PASS-ME-AROUND.

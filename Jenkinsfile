...
String ISPW_Application     = "DDL2"        // Change to your assigned application
...
node {
  ...
  stage('Mainframe Load')
  {
    ...
    *feature3* => QA3, per-branch''',
    ...
    gitCredentialsId: 'PMIDDL0-GITHUB', // GH CWCC
    gitRepoUrl: 'https://github.com/lock18/GitADCPDDL2.git',

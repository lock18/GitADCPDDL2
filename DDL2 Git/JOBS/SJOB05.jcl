//TJOB05 JOB (BENCHMARK),'ISPW TRAINING',NOTIFY=&SYSUID,
...
//ISPTLIB  DD DSN=&&ISPTLIB,DISP=(NEW,PASS),
//            UNIT=SYSDA,
//            SPACE=(TRK,(20,1,1)),
//            DCB=(RECFM=FB,LRECL=80,BLKSIZE=9040)
...
//         SPACE=(TRK,(10,1,1)),DCB=(RECFM=FB,LRECL=80,BLKSIZE=0)
//SYSTSPRT DD DSN=&&TEMP,
//            DCB=(RECFM=FB,LRECL=80,DSORG=PS,BLKSIZE=6000),
//            DISP=(NEW,PASS),SPACE=(TRK,(1,1),RLSE)
//SYSPRINT DD SYSOUT=*
//SYSOUT   DD SYSOUT=*
//SYSTSIN  DD *
  PROFILE MSGID

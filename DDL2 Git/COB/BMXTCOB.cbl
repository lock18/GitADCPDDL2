...
********
********  FIELDS USED BY CALLED PROGRAM BMXTSUBC TO CALCULATE
...
*********
       2000-PROCESS-HOURLY.
           ...
           CALL 'BMXTDATE' USING END-OF-MONTH-SW
                                 YRS-OF-SERVICE
                                 TODAYS-DATE
                                 WA-EMP-HIRE-DATE.
...
*********  RETURNED FROM BMXTSUBC, IT IS STORED IN A HOLD-TABLE.  THE
...
*********
       6100-PRINT-EMPLOYEE-DETAIL.
           ...
           MOVE EMP-DTL-NAME                  TO EMP-TB-NAME.
           MOVE EMP-DTL-REGION                TO EMP-TB-REGION.
           MOVE EMP-DTL-TYPE                  TO EMP-TB-TYPE.
           MOVE EMP-DTL-YRS-OF-SERVICE        TO EMP-TB-YRS-SERVICE.
           MOVE EMP-DTL-WAGES                 TO EMP-TB-WAGES.
           MOVE EMP-DTL-OT                    TO EMP-TB-OT.
           MOVE EMP-DTL-COMM                  TO EMP-TB-COMM.
           EXEC SQL
           INSERT INTO EMP
           VALUES(:EMP-TB-NAME,
           :EMP-TB-REGION,

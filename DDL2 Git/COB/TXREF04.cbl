...
000900*      WITH A LINK TO DATERTN
001000*
001100*      AND COPYLIBS   TXREFA    (HEADER)
001200*                     TXREFB    (LINK AREA)
001300* ======================================================
001400*  ISPW (TM)
...
008900     CALL 'DATERTN' USING PASS-ME-AROUND.
009000
...
013700     CALL 'DATERTN' USING PASS-ME-AROUND.
013800
...
014400        CALL 'DATERTN' USING PASS-ME-AROUND.
